...
public:
	...
	const iPoint* GetStepFromLastPath(int index);
...
struct PathNode
{
	...
	uint FindWalkableAdjacents(PathList& list_to_fill, const PathFinding& pathFinding) const;
