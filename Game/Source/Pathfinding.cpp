...
PathFinding::PathFinding(Application * app) : lastPath(DEFAULT_PATH_LENGTH), width(0), height(0)
{
	this->app = app;
}
...
// ----------------------------------------------------------------------------------
uint PathNode::FindWalkableAdjacents(PathList& listToFill, const PathFinding& pathFinding) const
{
	iPoint cell;
